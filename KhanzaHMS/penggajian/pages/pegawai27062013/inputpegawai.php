...
<div id="post">
    <h1 class="title">::[ Input Pegawai ]::</h1>
    <div class="entry">
        <form name="frm_unit" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <table width="100%" align="center">
                <tr class="head">
                    <td width="25%" >NIK</td><td width="">:</td>
		...
		<tr class="head">
                ...
                <tr class="head">
                    <td width="25%" >Kode Jenjang</td><td width="">:</td>
                    <td width="75%">
                ...
                <tr class="head">
                    ...
                    <td width="75%"><input name="npwp" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi10'));" type=text id="TxtIsi10" class="inputbox" value="<?php echo $npwp;?>" size="20" maxlength="15">
                ...
                <tr class="head">
                    ...
                    <td width="75%"><input name="tmp_lahir" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi12'));" type=text id="TxtIsi12" class="inputbox" value="<?php echo $tmp_lahir;?>" size="30" maxlength="20">
		...
		<tr class="head">
                    ...
                    <td width="75%"><input name="alamat" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi14'));" type=text id="TxtIsi14" class="inputbox" value="<?php echo $alamat;?>" size="50" maxlength="50">
                    <span id="MsgIsi14" style="color:#CC0000; font-size:10px;"></span>
                    </td>
                </tr>
				<tr class="head">
                    <td width="25%" >Kota</td><td width="">:</td>
                    <td width="75%"><input name="kota" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi15'));" type=text id="TxtIsi15" class="inputbox" value="<?php echo $kota;?>" size="30" maxlength="20">
		...
		<tr class="head">
			...
			<select name="ThnMulai" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi16'));" id="TxtIsi16">
				...
				<tr class="head">
                    <td width="25%" >Kode Ms Kerja <?php echo $ms_kerja?></td><td width="">:</td>
                    <td width="75%">
		...
		<tr class="head">
				...
				<tr class="head">
                    <td width="25%" >BPD</td><td width="">:</td>
                    <td width="75%">
                        <select name="bpd" class="text3" onkeydown="setDefault(this, document.getElementById('MsgIsi19'));" id="TxtIsi19">
                            <!-- <option id='TxtIsi2' value=' '>- Jenis Kelamin -</option> -->
                            <?php
                                if($action == "UBAH"){
                                    echo "<option id='TxtIsi19' value=$bpd>$bpd</option>";
                                }                                 
                            ?>
                            <option id='TxtIsi19' value='Y'>Y</option>
                            <option id='TxtIsi19' value='T'>T</option>
                        </select>
		...
		<tr class="head">
                    ...
                    <td width="75%"><input name="rekening" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi20'));" type=text id="TxtIsi20" class="inputbox" value="<?php echo $rekening;?>" size="30" maxlength="25">
                ...
                <tr class="head">
                    <td width="25%" >Wajib Masuk</td><td width="">:</td>
                    <td width="75%"><input name="wajibmasuk" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi22'));" type=text id="TxtIsi22" class="inputbox" value="<?php echo $wajibmasuk;?>" size="5" maxlength="2">
                    ...
                    Isi dgn "-3" jk ingin wajib masuk 1 bulan-2 hari-libur nasional
            ...
            <?php
                ...
                if (isset($BtnSimpan)) {
                    ...
                    $jnj_jabatan    = trim($_POST['jnj_jabatan']);
		    ...
		    $wajibmasuk     = trim($_POST['wajibmasuk']);
                    ...
                    if ((!empty($nik))&&(!empty($nama))&&(!empty($jk))&&(!empty($jbtn))&&(!empty($jnj_jabatan))&&
						(!empty($departemen))&&(!empty($bidang))&&(!empty($stts_wp))&&(!empty($stts_kerja))&&
						(!empty($npwp))&&(!empty($pendidikan))&&(!empty($tmp_lahir))&&
						(!empty($tgl_lahir))&&(!empty($alamat))&&(!empty($kota))&&(!empty($mulai_kerja))&&
						(!empty($ms_kerja))&&(!empty($indexins))&&(!empty($bpd))&&(!empty($rekening))) {
                        switch($_GET['action']) {
                            case "TAMBAH":
							...
							'$kota','$mulai_kerja','$ms_kerja','$indexins','$bpd','$rekening','$stts_aktif',
                                                        '$wajibmasuk','0','0','$mulai_kontrak','0'", " pegawai " );
                    ...
                    }else if ((empty($nik))||(empty($nama))||(empty($jk))||(empty($jbtn))||(empty($jnj_jabatan))||
								(empty($departemen))||(empty($bidang))||(empty($stts_wp))||(empty($stts_kerja))||(empty($npwp))||
								(empty($pendidikan))||(empty($tmp_lahir))||(empty($tgl_lahir))||(empty($alamat))||
								(empty($kota))||(empty($mulai_kerja))||(empty($ms_kerja))||(empty($indexins))||
								(empty($bpd))||(empty($rekening))) {
