...
?>
<div id="post">
    <h1 class="title">::[ Detail Tindakan Dokter Tahun <?php echo$tahun ;?> Bulan <?php echo$bulan ;?> ]::</h1>
    <div class="entry">
                ...
                if(mysql_num_rows($hasil)!=0) {
                    ...
                    while($baris = mysql_fetch_array($hasil)) {
                      ...
                      echo "<tr class='isi'>
                                <td width='70'>
                                    <center>"; ?>
                                    <a href="?act=InputTindakanDokter&action=HAPUS&tgl=<?php print $baris[0] ?>&tnd=<?php print $baris[2] ?>&id=<?php print $baris[1] ?>" onClick="if (!confirm('Anda yakin menghapus data tindakan tanggal <?php print $baris[0]?>?')) return false;">[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
                                <td>$baris[3]</td>
