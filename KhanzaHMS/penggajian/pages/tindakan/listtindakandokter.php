...
<div id="post">
    <h1 class="title">:: List Tindakan Dokter Tahun <?php echo$tahun ;?> Bulan <?php echo$bulan ;?> ::</h1>
    <div class="entry">   
    ...
    <?php
        if(mysql_num_rows($hasil)!=0) {
            ...
            $i=$jumlah1/19;
            $i=ceil($i);
            echo("Data : $jumlah, Ttl.JM : ".formatDuit($ttljm)."  <a target=_blank href=/penggajian/pages/tindakan/laporantindakandokter.php?&keyword=$keyword>| Laporan |</a> ");
        }
    ?>
    </div>
</div>
