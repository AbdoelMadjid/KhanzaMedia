   ...
   <?php
        ...
        if(mysql_num_rows($hasil)!=0) {
            echo "<table width='5000px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    ...
                    <tr class='head'>
                         <td valign='top' width='80px'><div align='center'><font size='2' face='Verdana'><strong>NIK</strong></font></div></td>
                         <td valign='top' width='180px'><div align='center'><font size='2' face='Verdana'><strong>Nama</strong></font></div></td>
                         <td valign='top' width='100px'><div align='center'><font size='2' face='Verdana'><strong>Jabatan</strong></font></div></td>
                         <td valign='top' width='60px'><div align='center'><font size='2' face='Verdana'><strong>Kode Jenjang</strong></font></div></td>
                         <td valign='top' width='60px'><div align='center'><font size='2' face='Verdana'><strong>Depart</strong></font></div></td>
                         <td valign='top' width='60px'><div align='center'><font size='2' face='Verdana'><strong>Kode Index</strong></font></div></td>
                         <td valign='top' width='60px'><div align='center'><font size='2' face='Verdana'><strong>Index Kary</strong></font></div></td>
                         <td valign='top' width='200px'><div align='center'><font size='2' face='Verdana'><strong>Jumlah Hari</strong></font></div></td>
                         <td valign='top' width='70px'><div align='center'><font size='2' face='Verdana'><strong>Jml.Index Lembur</strong></font></div></td>
                         <td valign='top' width='910px'><div align='center'><font size='2' face='Verdana'><strong>Gaji & Tunjangan diterima</strong></font></div></td>
                         <td valign='top' width='310px'><div align='center'><font size='2' face='Verdana'><strong>Lembur Diterima</strong></font></div></td>
                         <td valign='top' width='760px'><div align='center'><font size='2' face='Verdana'><strong>Tambahan Gaji Diterima</strong></font></div></td>
                         <td valign='top' width='100px'><div align='center'><font size='2' face='Verdana' color='green'><strong>Total Gaji</strong></font></div></td>
                         <td valign='top' width='920px'><div align='center'><font size='2' face='Verdana'><strong>Potongan Gaji</strong></font></div></td>
                         <td valign='top' width='100px'><div align='center'><font size='2' face='Verdana' color='green'><strong>Total Gaji Diterima</strong></font></div></td>
                    </tr>";
                    while($baris = mysql_fetch_array($hasil)) {
                        $_sqlgp    = "SELECT `gapok1`, `gapok2`, `gapok3`
                            from pendidikan  where tingkat='$baris[16]' ";
                            $hasilgp   = bukaquery($_sqlgp);
                            $barisgp   = mysql_fetch_row($hasilgp);
                            $gapokgp     = 0;

                          if($baris[17]<1){
                             $gapokgp=$barisgp[0];
                          }else if(($baris[17]>=1)&&($baris[17]<3)){
                             $gapokgp=$barisgp[1];
                          }else if($baris[17]>=3){
                             $gapokgp=$barisgp[2];
                          }
					 ...
					 <TD valign='top'>".formatDuit($tnjjbtn)."&nbsp;</TD>
					     ...
					     and pnm_tnj_harian.id='$baris[0]'";
                                            ...
                                            while($baris16 = mysql_fetch_array($hasil16)) {
                                                ...
                                                echo "<tr class='isi3'><td valign='top' width='150px'>$baris16[0]&nbsp;</td><td valign='top'>: ".formatDuit($ttln*$baris16[1])."&nbsp;</td></tr>";
                                            }
				  ...
				  <td valign='top'>
					 ...
					 <TD valign='top'>$ttlindex&nbsp;</TD>
                                         <TD valign='top' width='100px'>";
                                            ...
                                            $pengurang="";
					    if($baris[12]==0){
                                                $_sqltambahan2="SELECT count(indexins),sum(potongan) from tambahanpotongan
                                                                where indexins='$baris[6]'"; 
                                                $hasilpotongan2=bukaquery($_sqltambahan2);                                           
                                                $barispotongan2= mysql_fetch_array($hasilpotongan2);
                                                $countindex=$barispotongan2[0];
                                                $sumindex=$barispotongan2[1];
                                                
                                                $_sqltambahan3="SELECT count(kdindex) from indekref
                                                                where kdindex='$baris[6]'"; 
                                                $hasilpotongan3=bukaquery($_sqltambahan3);                                           
                                                $barispotongan3= mysql_fetch_array($hasilpotongan3);
                                                $countindexref=$barispotongan3[0];
                                                
                                                if($sumindex>0){
                                                    $pengurang="+($sumindex/($countindexref-$countindex))";
                                                }                                                
                                            }else if($baris[12]>0){
                                                $pengurang="*((100-$baris[12])/100)";
                                            }  
                                            
                                            if($baris[6]!="DIR"){
                                                $_sql23="SELECT ($ttlindex/sum(indextotal.ttl))*((indexins.persen/100)*total_insentif) $pengurang
                                                ...
                                                if($baris[0]=="43"){
                                                    $_sql23="SELECT ($ttlindex/sum(indextotal.ttl))*((indexins.persen/100)*total_insentif)*1.8 $pengurang
                                                    from indextotal,indexins,set_insentif where
                                                    set_insentif.tahun='$tahun' and set_insentif.bulan='$bulanindex' and
                                                    indextotal.kdindex=indexins.dep_id and
                                                    indextotal.kdindex='MNJ'";                                                    
            ...
            echo "<tr class='head'>
					 ...
					 <TD valign='top' width='65px'>$ttlttlindex&nbsp;</TD>
                         ...
                         <td valign='top' width='100px'><div align='center'><font size='2' color='green'><i>".formatDuit($ttlttlgaji)."</i></font></div></td>
                         <td valign='top'>
                                     <table>
				       <TR class='isi5'>
