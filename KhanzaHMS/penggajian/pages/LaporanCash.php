				  ...
				  ";
					     ...
					     and pnm_tnj_bulanan.id='$baris[0]'";
                                            ...
                                            if($baris[6]!="DIR"){
                                                ...
                                                $_sql23="SELECT ($ttlindex/sum(indextotal.ttl))*((indexins.persen/100)*total_insentif)*1.8
                                                    from indextotal,indexins,set_insentif where
                                                    set_insentif.tahun='$tahun' and set_insentif.bulan='$bulanindex' and
                                                    indextotal.kdindex=indexins.dep_id and
                                            ...
                                            $ttlgaji=$jmltmb+$lemburhb+$lemburhr+$gapok+$tnjjbtn+$tnjtnj+$tnjtnjbln+$ttlkasift+$ttlkasift+$tmbhjgmlm+$tmbahanjg+$tnjhadir;
