<?php
	...
	function samping()
	{
		...
		if (cekSessiAdmin()):
			echo "<br/>  <h2>.: REFERENSI &nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :.</h2>
                                 <p>
                                 <ul class=\"left_menu\">
					...
					<li class=\"even\"><a href='index.php?act=ListInsentif'>Insentif</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListAkte'>Pendapatan Akte</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListResume'>Pendapatan Resume</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListTuslah'>Pendapatan Tuslah</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListWarung'>Pendapatan Warung</a></li>
				  </ul>
                                  </p>
                               ";
					...
					<li class=\"odd\"><a href='index.php?act=ListCariPegawai'>Data Pegawai</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListPresensi'>Lembur Pegawai</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListKeanggotaan'>Keanggotaan</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListPotongan'>Potongan Gaji</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListTindakan'>Tindakan Medis</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListTunjangan'>Tunjangan</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListJasLa'>Jasa Lain</a></li>
					<li class=\"even\"><a href='index.php?act=ListKS&action=TAMBAH'>Daftar Kasift</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListRj'>Rwt Jln Spesialis</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListLampiran&action=LIHAT'>Lampiran 1</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListJam&action=TAMBAH'>Jam Jaga Departemen</a></li>                                        
				  </ul>
                                  </p>
                               ";
                        calender();
                ...
                elseif(cekSessiPegawai ()):
					...
					<li class=\"odd\"><a href='index.php?act=ListSttswp'>Status WP</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListJenjang'>Jenjang Jabatan</a></li>
					<li class=\"odd\"><a href='index.php?act=ListDepartemen'>Departemen</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListAkte'>Pendapatan Akte</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListResume'>Pendapatan Resume</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListTuslah'>Pendapatan Tuslah</a></li>
				  </ul>
                                  </p>
                               ";
					...
					<li class=\"even\"><a href='index.php?act=ListKS&action=TAMBAH'>Daftar Kasift</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListRj'>Rwt Jln Spesialis</a></li>
                                        <li class=\"even\"><a href='index.php?act=ListLampiran&action=LIHAT'>Lampiran 1</a></li>
                                        <li class=\"odd\"><a href='index.php?act=ListHistory'>History Gaji</a></li>
				  </ul>
                                  </p>
                               ";
                        calender();
