...
<html>
    ...
    reportsqlinjection();      
        ...
        $_sql = "select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,
                   ...
                   and poliklinik.nm_poli like '%$unit%'
                   and dokter.nm_dokter like '%$dokter%'";            
                                      ...
                                      while($barispesan = mysql_fetch_array($hasil)) { 
                                          ...
                                          echo "
                                            <tr class='isi15'>
                                                ...
                                                <td>".$umurlk." &nbsp;</td>
                                                <td>".$umurpr." &nbsp;</td>
                                                <td>".$barispesan["alamat"]." &nbsp;</td>
                                                <td>".
                                                getOne("select penyakit.nm_penyakit from penyakit inner join rawat_jl_dr 
                                                        on rawat_jl_dr.kd_penyakit=penyakit.kd_penyakit
                                                        where rawat_jl_dr.no_rawat='".$barispesan["no_rawat"]."' ")." &nbsp;</td>
