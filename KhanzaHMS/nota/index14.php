          ...
          echo "<table width='$barisset[1]'  border='0' align='left' cellpadding='0' cellspacing='0' class='tbl_form'>
                <tr class='isi14'>
                 ...
                 <tr class='isi14'>
                    ...
                    <td width='50%'>: $nonota</td>
                    <td width='30%' colspan=2>$barisins[2], ".substr($tanggal,8,2)."-".substr($tanggal,5,2)."-".substr($tanggal,0,4)."</td>
                 </tr> 
                 <tr class='isi14'>
                    <td width='20%'>
                       <font color='000000' size='2' face='Tahoma'>Sales</font>
                    </td>
                    <td width='50%'>: $barisuser[0]</td>
                    <td width='30%' colspan=2>$nm_member</td>
                 </tr> 
                 <tr class='isi14'>
                    <td width='20%'>
                    ...
                    <td width='50%'></td>
                    <td width='30%' colspan=2>Jatuh Tempo : ".substr($tgltempo,8,2)."-".substr($tgltempo,5,2)."-".substr($tgltempo,0,4)."</td>
                 </tr>
                 </table>
                 </td>
                 </tr>
