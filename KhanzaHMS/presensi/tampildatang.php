...
<div id="post">
    ...
    <div class="entry">    
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" pageion="" enctype=multipart/form-data>
        <?php
                antisqlinjection("?page=TampilDatang");
                echo "";                
                $keyword      =$_GET['keyword'];
                //$keyword     =$_GET['keyword'];
                echo "<input type=hidden name=keyword value=$keyword><input type=hidden name=pageion value=$pageion>";
        ?>
    ...
    <?php
        ...
        $awal=cleankar($_GET['awal']);
        $order=cleankar($_GET['order']);
