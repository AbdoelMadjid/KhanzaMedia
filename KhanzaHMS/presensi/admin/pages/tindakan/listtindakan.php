...
<div id="post">
    <h1 class="title">:: List Tindakan Paramedis Tahun <?php echo$tahun ;?> Bulan <?php echo$bulan ;?> ::</h1>
    <div class="entry">   
            ...
            echo "<table width='1050px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                    ...
                    while($baris = mysql_fetch_array($hasil)) {
                        ...
                        echo "<tr class='isi' title='$baris[1] $baris[2]'>
                                ...
                                <td><a href=?act=InputTindakan&action=TAMBAH&id=$baris[0]>";$_sql2="select master_tindakan.nama,sum(tindakan.jmlh)
    ...
    <?php
        if(mysql_num_rows($hasil)!=0) {
            ...
            $i=$jumlah1/19;
            $i=ceil($i);
            echo("Data : $jumlah, Ttl.JM : ".formatDuit($ttljm)."  <a target=_blank href=/penggajian/pages/tindakan/laporantindakan.php?&keyword=$keyword>| Laporan |</a> ");
        }
    ?>
    </div>
</div>
