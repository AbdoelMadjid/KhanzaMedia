...
<div class="y">
<div id="post">
    <h1 class="title">::[ Status Keanggotaan Koperasi ]::</h1>
    ...
    <div class="entry">
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
                ...
                if(mysql_num_rows($hasil)!=0) {
                    echo "<table width='600px' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                            <tr class='head'>
                                ...
                                <td width='170px'><div align='center'><font size='2' face='Verdana'><strong>Status Keanggotaan</strong></font></div></td>
                                <td width='250px'><div align='center'><font size='2' face='Verdana'><strong>Besar Simpanan Wajib</strong></font></div></td>
                            </tr>";
                    while($baris = mysql_fetch_array($hasil)) {
                      echo "<tr class='isi'>
                                <td>
                                    ...
                                    <a href="?act=DetailKoperasi&action=HAPUS&stts=<?php print $baris[0] ?>" onClick="if (!confirm('Anda yakin menghapus data status keanggotaan koperasi <?php print $baris[0]?>?')) return false;">[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
                                <td>$baris[0]</td>
            ...
            } else {echo "<b>Data Status Keanggotaan Koperasi masih kosong !</b>";}
        ?>
        </div>
        </form>
        <?php
