                ...
                if(mysql_num_rows($hasil)!=0) {
                    ...
                    while($baris = mysql_fetch_array($hasil)) {                        
                      echo "<tr class='isi'>
                                <td width='70'>
                                    <center>"; ?>
                                    <a href="?act=InputJasLa&action=HAPUS&thn=<?php print $baris[0] ?>&bln=<?php print $baris[1] ?>&id=<?php print $baris[2] ?>&bsr_jasa=<?php print $baris[3] ?>" onClick="if (!confirm('Anda yakin menghapus data ini ?')) return false;">[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
